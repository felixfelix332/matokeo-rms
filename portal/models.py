...
class AcademicSession(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'portal_academicsession'
...
class AttendanceEntry(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'portal_attendanceentry'
